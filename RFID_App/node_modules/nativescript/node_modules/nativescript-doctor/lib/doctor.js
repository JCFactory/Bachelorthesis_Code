...
class Doctor {
    ...
    getInfos(config) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!config || !config.platform || config.platform === constants_1.Constants.ANDROID_PLATFORM_NAME) {
                result = result.concat(this.getAndroidInfos(sysInfoData));
            }
            if (!config || !config.platform || config.platform === constants_1.Constants.IOS_PLATFORM_NAME) {
