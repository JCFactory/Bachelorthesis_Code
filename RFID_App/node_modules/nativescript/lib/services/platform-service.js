...
class PlatformService extends events_1.EventEmitter {
    constructor($devicesService, $preparePlatformNativeService, $preparePlatformJSService, $errors, $fs, $logger, $npmInstallationManager, $platformsData, $projectDataService, $hooksService, $pluginsService, $projectFilesManager, $mobileHelper, $hostInfo, $devicePathProvider, $npm, $devicePlatformsConstants, $projectChangesService, $analyticsService, $terminalSpinnerService) {
        super();
    ...
    initialPrepare(platform, platformData, appFilesUpdaterOptions, platformTemplate, projectData, config, nativePrepare, skipNativeCheckOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            this.validatePlatform(platform, projectData);
            ...
            const changesInfo = yield this.$projectChangesService.checkForChanges(platform, projectData, {
                bundle,
    ...
    ensurePlatformInstalled(platform, platformTemplate, projectData, config, appFilesUpdaterOptions, nativePrepare) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const platformData = this.$platformsData.getPlatformData(platform, projectData);
            const prepareInfo = this.$projectChangesService.getPrepareInfo(platform, projectData);
            if (appFilesUpdaterOptions.bundle && this.isPlatformInstalled(platform, projectData) && !this.$fs.exists(platformData.configurationFilePath) && (!prepareInfo || !prepareInfo.nativePlatformStatus || prepareInfo.nativePlatformStatus !== "3")) {
