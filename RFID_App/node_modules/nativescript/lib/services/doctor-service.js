...
class DoctorService {
    ...
    printWarnings(configOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            }, () => nativescript_doctor_1.doctor.getInfos());
            ...
            yield this.$injector.resolve("platformEnvironmentRequirements").checkEnvironmentRequirements(null);
        });
    }
    runSetupScript() {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    canExecuteLocalBuild(platform) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const infos = yield nativescript_doctor_1.doctor.getInfos({ platform });
