...
class CommandsService {
    constructor($analyticsSettingsService, $commandsServiceProvider, $errors, $fs, $hooksService, $injector, $logger, $options, $resources, $staticConfig, $helpService, $extensibilityService) {
