        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (liveSyncInfo.filesToSync.length) {
                ...
                if (existingFiles.length) {
                    ...
                    modifiedLocalToDevicePaths = yield this.transferFiles(deviceAppData, localToDevicePaths, projectFilesPath, false);
                }
            }
    ...
    transferFiles(deviceAppData, localToDevicePaths, projectFilesPath, isFullSync) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (isFullSync) {
                ...
                transferredFiles = yield deviceAppData.device.fileSystem.transferFiles(deviceAppData, localToDevicePaths);
            }
