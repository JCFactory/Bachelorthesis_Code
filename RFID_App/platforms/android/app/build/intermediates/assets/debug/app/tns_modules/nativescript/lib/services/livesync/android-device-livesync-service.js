...
class AndroidDeviceLiveSyncService extends device_livesync_service_base_1.DeviceLiveSyncServiceBase {
    constructor(_device, $mobileHelper, $devicePathProvider, $injector, $androidProcessService, $platformsData) {
        super($platformsData);
    ...
    restartApplication(deviceAppData, projectName) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.device.applicationManager.restartApplication({ appId: deviceAppData.appIdentifier, projectName });
        });
    }
